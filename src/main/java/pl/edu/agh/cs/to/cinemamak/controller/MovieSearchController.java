...
public class MovieSearchController extends ExtractedTableController<Movie> {
    ...
    public MovieSearchController(MovieService movieService, DialogManager dialogManager) {
        super(movieService);
    ...
    public void setSelectedMovie(Movie mv) {
        this.selectedMovie = Optional.of(mv);
    }
